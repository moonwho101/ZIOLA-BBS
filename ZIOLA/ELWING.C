...
enum notes {
    ...
    SHORT=20,EIGHTH = 125, QUARTER = 250, HALF = 500, WHOLE = 1000, END = 0
...
main () {
   ...
   new_mail_read=OFF;
   normal[0] = 6; normal[1] = 7; normal[2] = 6; normal[3] = 7;
   normal[4] = 6; normal[5] = 6;

   reply_s[0] = 6; reply_s[1] = 7; reply_s[2] = 8; reply_s[3] = 6;
   reply_s[4] = 7; reply_s[5] = 6; reply_s[6] = 6;
...
*/
	 ...
	 blue_bar=OFF;
      ...
      xloc=0;  yloc=0;  direct_write=ON;   upx=0;  upy=0;  lowx=23;
      lowy=79; bottom=lowx+1;
